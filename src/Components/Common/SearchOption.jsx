        ...
        <React.Fragment>
            <form className="app-search d-none d-md-block">
                <div className="position-relative">
                    ...
                    <span className="search-widget-icon">      <CiSearch /></span>
                    <span className="search-widget-icon search-widget-icon-close d-none"
                        id="search-close-options"><IoMdClose /></span>
                </div>
