...
export const postFakesetPassword = data => api.create(url.POST_FAKE_SETPASSWORD, data);
...
export const getCountries = (countrie) => api.get(url.GET_COUNTRIES, countrie);
export const deleteCountrie = (countrie) => api.delete(url.DELETE_COUNTRIE, { headers: { countrie } });
export const addNewCountrie = (countrie) => api.create(url.ADD_NEW_COUNTRIE, countrie);
export const updateCountrie = (countrie) => api.put(url.UPDATE_COUNTRIE, countrie);

export const getVendors = (vendor) => api.get(url.GET_VENDORS, vendor);
export const deleteVendor = (vendor) => api.delete(url.DELETE_VENDOR, { headers: { vendor } });
export const addNewVendor = (vendor) => api.create(url.ADD_NEW_VENDOR, vendor);
export const updateVendor = (vendor) => api.put(url.UPDATE_VENDOR, vendor);

export const getRoles = (role) => api.get(url.GET_ROLES, role);
export const deleteRole = (role) => api.delete(url.DELETE_ROLE, { headers: { role } });
export const addNewRole = (role) => api.create(url.ADD_NEW_ROLE, role);
export const updateRole = (role) => api.put(url.UPDATE_ROLE, role);
...
export const getCategorie = (categorie) => api.get(url.GET_CATEGORIES, categorie);
export const deleteCategorie = (categorie) => api.delete(url.DELETE_CATEGORIE, { headers: { categorie } });
export const addNewCategorie = (categorie) => api.create(url.ADD_NEW_CATEGORIE, categorie);
export const updateCategorie = (categorie) => api.put(url.UPDATE_CATEGORIE, categorie);


export const getUsers = (user) => api.get(url.GET_USERS, user);
export const deleteUser = (user) => api.delete(url.DELETE_USER, { headers: { user } });
export const addNewUser = (user) => api.create(url.ADD_NEW_USER, user);
export const updateUser = (user) => api.put(url.UPDATE_USER, user);


export const getCities = (citie) => api.get(url.GET_CITIES, citie);
export const deleteCitie = (citie) => api.delete(url.DELETE_CITIE, { headers: { citie } });
export const addNewCitie = (citie) => api.create(url.ADD_NEW_CITIE, citie);
export const updateCitie = (citie) => api.put(url.UPDATE_CITIE, citie);

export const getCityAreas = (cityArea) => api.get(url.GET_CITYAREAS, cityArea);
export const deleteCityArea = (cityArea) => api.delete(url.DELETE_CITYAREA, { headers: { cityArea } });
export const addNewCityArea = (cityArea) => api.create(url.ADD_NEW_CITYAREA, cityArea);
export const updateCityArea = (cityArea) => api.put(url.UPDATE_CITYAREA, cityArea);

export const getStates = (state) => api.get(url.GET_STATES, state);
export const deleteState = (state) => api.delete(url.DELETE_STATE, { headers: { state } });
export const addNewState = (state) => api.create(url.ADD_NEW_STATE, state);
export const updateState = (state) => api.put(url.UPDATE_STATE, state);


export const getProduct = (product) => api.get(url.GET_PRODUCTS, product);
export const deleteProduct = (product) => api.delete(url.DELETE_PRODUCT, { headers: { product } });
export const addNewProduct = (product) => api.create(url.ADD_NEW_PRODUCT, product);
export const updateProduct = (product) => api.put(url.UPDATE_PRODUCT, product);
